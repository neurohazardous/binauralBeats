function ABRPreprocS16(thepath, thefile, thename, generalpath)

%% Establish the directory of EEGLAB
EEGLAB_dir='/Users/hectorOrozco/Documents/MATLAB/eeglab13_5_4b/';
...
EEG = pop_select( EEG,'nochannel', {'Nose' 'VEOGL' 'M1' 'HEOGR' 'EXG7' 'EXG8' 'GSR1' 'Resp' 'Left' 'Right' 'Status'});
EEG = eeg_checkset( EEG );
...
%% SAVE FILE
EEG = pop_saveset( EEG, 'filename',[thefile(1:end-4) '_ABR_Preproc.set'],'filepath', [generalpath 'Pre-proc/' thename '/']);
EEG = eeg_checkset( EEG );
